...
export default class HistoryDetail extends Component {
    ...
    render() {
        const { athletesArray, relayFinishTime, startTime, name, watchStop, timerMode } = this.props
        ...
        function showRelayTime() {
            if(timerMode === RACE) {
                ...
                return <Text style={styles.relayTime}>Relay Finish Time: {relay.m}:{relay.s}.{relay.ms}</Text>
            }
        }
        ...
        return (
            <View style={[styles.history]}>
                <View style={styles.textSection}>
                    ...
                    <Text style={styles.raceDate}>{month}/{date}/{year}</Text>
                    {showRelayTime()}
                    <Text style={styles.watchStop}>Watch Finish Time: {finish.m}:{finish.s}.{finish.ms}</Text>
                </View>
                <ListView
